...
namespace WindowsFormsApp1
{
    public partial class Customer : Form
    {
        ...
        private void butsave_Click(object sender, EventArgs e)
        {
            ...
            {
                conn.Open();
                SqlCommand cmd = new SqlCommand("insert into customertab (customerid, customername, phone) values (@CustomerId, @CustomerName, @Phone)", conn);
        ...
        private void butdelete_Click(object sender, EventArgs e)
        {
            ...
            {
                conn.Open();
                SqlCommand cmd = new SqlCommand("delete from customertab where customerid=@CustomerId", conn);
                cmd.Parameters.AddWithValue("@CustomerId", int.Parse(custidtxt.Text));
                cmd.ExecuteNonQuery();
